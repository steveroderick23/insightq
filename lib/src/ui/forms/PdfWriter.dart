...
import 'package:googleapis/drive/v3.dart' as v3Drive;
import 'package:googleapis_auth/auth_io.dart';
import 'package:insightq/src/common/GoogleDrive.dart';
...
Future writeToPdf(mat.BuildContext context) async {
  ...
  if (permissions.containsKey(PermissionGroup.storage) && permissions[PermissionGroup.storage] == PermissionStatus.granted){
    ...
    File file = File(directory.path + '/example.pdf');
    file.writeAsBytesSync(pdf.save());

    GoogleDrive(context).upload(file);
